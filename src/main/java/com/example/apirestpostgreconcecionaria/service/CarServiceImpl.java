...
import com.example.apirestpostgreconcecionaria.repository.CarRepository;
...
public class CarServiceImpl implements CarService{
    ...
    public void deleteAllById(List<Long> ids) {
        ...
        if (CollectionUtils.isEmpty(ids)){
            log.warn("Trying to delete an empty or null ids list");
            return;
        }
    ...
    @Override
    public List<Car> findByModelContainig(String model) {
        return this.carRepository.findByModelContainig(model);
    }
    ...
    @Override
    public List<Car> findByAvalibleTrue() {
        return this.carRepository.findByAvalibleTrue();
    }

    @Override
    public Long deleteAllByAvailabFalse() {
        return this.carRepository.deleteAllByAvailabFalse();
    }
}
